...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Testi Carousel
        // var swiperTesti = new Swiper(".testi-carousel-22", {
        //     slidesPerView: 2,
        //     spaceBetween: 24,
        //     slidesPerGroup: 1,
        //     loop: true,
        ...
        // Testi Carousel
        var swiperTesti = new Swiper(".testi-carousel-24", {
            slidesPerView: 1,
            spaceBetween: 24,
            slidesPerGroup: 1,
            loop: true,
        ...
        // Testi Carousel
        var swiperTesti = new Swiper(".insta-wrap-slider", {
            slidesPerView: 3,
            spaceBetween: 24,
            slidesPerGroup: 1,
            loop: true,
    ...
    var testimonials = new Swiper(".content-carousel", {
        ...
        spaceBetween: 0,
        loop: true,
        autoplay: { delay: 3000, disableOnInteraction: false }, // safe autoplay config
        speed: 600,
        pagination: { el: ".swiper-pagination", clickable: true },
        navigation: { nextEl: ".testimonial-next", prevEl: ".testimonial-prev" },
        on: {
            init: function () {
                updateActiveShape(this.realIndex);
            },
    ...
    // helper: toggle active on .shapes > div
    function updateActiveShape(idx) {
        const shapeDivs = document.querySelectorAll(".testimonial__area .shapes > div");
        // guard: à¦¯à¦¦à¦¿ à¦¸à§à¦²à¦¾à¦‡à¦¡ > à¦¶à§‡à¦ª à¦¹à§Ÿ, modulo à¦¨à¦¿à¦¨
        const safeIndex = shapeDivs.length ? (idx % shapeDivs.length) : 0;

        shapeDivs.forEach(d => d.classList.remove("active"));
        if (shapeDivs[safeIndex]) {
            shapeDivs[safeIndex].classList.add("active");
        }
    }

    // bonus: à¦¶à§‡à¦ªà§‡ à¦•à§à¦²à¦¿à¦• à¦•à¦°à¦²à§‡ à¦¸à§‡à¦‡ à¦¸à§à¦²à¦¾à¦‡à¦¡à§‡ à¦¯à¦¾à¦“à§Ÿà¦¾
    document.querySelectorAll(".testimonial__area .shapes > div").forEach((d, i) => {
        d.style.cursor = "pointer";
        d.addEventListener("click", () => testimonials.slideToLoop(i));
    });
