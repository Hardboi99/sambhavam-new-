...
@section('title', 'Dr. Madhukar Gumble | Sambhavam - Learn. Innovate. Lead. Create Impact.')
    ...
    <div class="ld-wrap">
        ...
        <div class="ld-profile">
            <div class="ld-photo-frame">
                <img class="ld-photo" src="{{ asset('images/faculty/madhukar_gumble.png') }}" alt="Dr. Madhukar Gumble">
            </div>
            <div class="ld-name-block">
                <h2 class="ld-name">Dr. Madhukar Gumble</h2>
                <p class="ld-role">Director | Sambhavam Foundation</p>
                <p class="ld-tagline">Educationist &amp; Social Development Leader</p>
            </div>
        </div>
        ...
        <div class="ld-bio-card">
            ...
            <p class="ld-bio-text">
                Dr. Madhukar Gumble is a distinguished educationist, social development professional and institution developer with over four decades of experience in grassroots development. Founder of Apeksha Homoeo Society (AHS), he has led transformative initiatives across education, health, livelihoods, sustainable agriculture, water and community development in Maharashtra. A respected mentor and development leader, he brings to Sambhavam deep expertise in institution building, community empowerment and nurturing future leaders for meaningful social impact.
            </p>
