...
@section('title', 'Ms. Deepti Gumber Bhatnagar | Sambhavam - Learn. Innovate. Lead. Create Impact.')
    ...
    <div class="ld-wrap">
        ...
        <div class="ld-profile">
            <div class="ld-photo-frame">
                <img class="ld-photo" src="{{ asset('images/faculty/deepti-bhatnagar.webp') }}" alt="Ms. Deepti Gumber Bhatnagar">
            </div>
            <div class="ld-name-block">
                <h2 class="ld-name">Ms. Deepti Gumber Bhatnagar</h2>
                <p class="ld-role">Director | Sambhavam Foundation</p>
                <p class="ld-tagline">Education &amp; Sustainability Leader &bull; Climate &amp; Nature Expert &bull; Knowledge &amp; Capacity-Building Professional</p>
            </div>
        </div>
        ...
        <div class="ld-bio-card">
            ...
            <p class="ld-bio-text">
                Ms. Deepti Gumber Bhatnagar is a global education, sustainability and climate resilience leader with over 20 years of experience in knowledge and capacity building, biodiversity conservation, climate adaptation, nature-based solutions and sustainable development. With an M.Sc. in Environmental Management, she has led multidisciplinary programmes for governments, multilateral development banks, UN agencies and international organisations across Africa, Asia and the Americas. At Sambhavam, she brings global expertise to advance experiential education, sustainability learning, future-ready skills and youth leadership, connecting academic knowledge with real-world challenges and global development priorities.
            </p>
